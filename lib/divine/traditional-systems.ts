...
const zigeunerEntries = [
  [
    'Beständigkeit · Constancy',
    'steadiness',
    'What is consistent can be trusted. Continue the practice, promise, or relationship that has already proved its strength.',
    'positive',
  ],
  [
    'Besuch · Visit',
    'arrival',
    'A person, invitation, or fresh influence crosses the threshold. Make room for direct contact.',
    'positive',
  ],
  [
    'Botschaft · Message',
    'news',
    'News moves quickly and changes the atmosphere. Listen for the actual message before supplying a story around it.',
    'neutral',
  ],
  [
    'Brief · Letter',
    'document',
    'A written message, record, or agreement makes the matter concrete. Read the exact words and preserve the evidence.',
    'neutral',
  ],
  [
    'Dieb · Thief',
    'depletion',
    'Time, trust, attention, or property is being taken without fair exchange. Secure what matters and inspect the unnoticed leak.',
    'challenging',
  ],
  [
    'Eifersucht · Jealousy',
    'comparison',
    'Comparison distorts perception and turns desire into surveillance. Name the unmet need without making another person its prisoner.',
    'challenging',
  ],
  [
    'Etwas Geld · Some Money',
    'small gain',
    'A modest payment, saving, or useful resource arrives. Small amounts become consequential when handled deliberately.',
    'positive',
  ],
  [
    'Falschheit · Falseness',
    'disguise',
    'Appearance and intention do not match. Verify through conduct, timing, and what remains consistent when the performance drops.',
    'challenging',
  ],
  [
    'Feind · Enemy',
    'opposition',
    'An opposing interest, hostile pattern, or open conflict has entered the field. Respond strategically rather than reactively.',
    'challenging',
  ],
  [
    'Fröhlichkeit · Merriment',
    'celebration',
    'Pleasure, company, and shared ease restore proportion. Let joy be part of the work rather than a reward indefinitely postponed.',
    'positive',
  ],
  [
    'Gedanken · Thought',
    'reflection',
    'The decisive movement is still inward. Give the idea enough quiet to become an intention, then test it through action.',
    'neutral',
  ],
  [
    'Geistlicher · Priest',
    'counsel',
    'Conscience, tradition, or a trusted adviser asks for a principled response. Separate genuine guidance from borrowed authority.',
    'neutral',
  ],
  [
    'Geld · Money',
    'resources',
    'Finances, value, and material leverage are central. Count what is available, owed, and worth protecting before deciding.',
    'positive',
  ],
  [
    'Geliebte · Sweetheart',
    'beloved woman',
    'A beloved woman—or the receptive partner in the matter—comes into focus. Her actions and nearest cards define the role.',
    'neutral',
  ],
  [
    'Geliebter · Lover',
    'beloved man',
    'A beloved man—or the active partner in the matter—comes into focus. Read the surrounding cards as his circumstances and intent.',
    'neutral',
  ],
  [
    'Geschenk · Gift',
    'offering',
    'Help, affection, insight, or a useful object is offered. Receive it clearly, including any obligation attached to acceptance.',
    'positive',
  ],
  [
    'Glück · Fortune',
    'good fortune',
    'Conditions turn favorably and widen what is possible. Use the opening while remaining responsible for what follows.',
    'positive',
  ],
  [
    'Haus · House',
    'foundation',
    'Home, property, family structure, or a place of safety contains the issue. Stabilize the foundation before expanding it.',
    'positive',
  ],
  [
    'Heirat · Marriage',
    'union',
    'A relationship, contract, or shared obligation binds separate lives or interests. Consider both devotion and terms.',
    'positive',
  ],
  [
    'Hoffnung · Hope',
    'expectation',
    'A desired future remains possible but not immediate. Keep faith practical by tending the conditions that let it arrive.',
    'positive',
  ],
  [
    'Kind · Child',
    'beginning',
    'A child, fresh start, or inexperienced part of the self needs protection and room to learn without premature demands.',
    'neutral',
  ],
  [
    'Krankheit · Sickness',
    'weakness',
    'Energy is reduced and the system needs care. Slow the pace, address the strain, and seek qualified help where appropriate.',
    'challenging',
  ],
  [
    'Liebe · Love',
    'affection',
    'Affection, devotion, or genuine care is the motive that matters. Let loving behavior—not intensity alone—prove the bond.',
    'positive',
  ],
  [
    'Offizier · Officer',
    'authority',
    'Discipline, official authority, or an institution sets the terms. Precision and composure carry more force than display.',
    'neutral',
  ],
  [
    'Reise · Journey',
    'movement',
    'Travel, distance, or a longer transition changes perspective. Prepare for the route rather than fixating only on arrival.',
    'neutral',
  ],
  [
    'Richter · Judge',
    'decision',
    'A formal judgment, evaluation, or ethical reckoning is due. Present the clearest facts and accept the weight of the decision.',
    'neutral',
  ],
  [
    'Sehnsucht · Longing',
    'yearning',
    'Desire reaches across distance, absence, or delay. Ask whether the longing is guiding action or replacing it.',
    'neutral',
  ],
  [
    'Tod · Death',
    'ending',
    'A condition has reached its natural limit. Grieve what closes and stop requiring the finished form to carry new life.',
    'challenging',
  ],
  [
    'Traurigkeit · Sadness',
    'grief',
    'Sorrow asks to be felt without becoming the whole horizon. Give the loss honest space and let support reach it.',
    'challenging',
  ],
  [
    'Treue · Fidelity',
    'loyalty',
    'Loyalty, reliability, and kept promises strengthen the situation. Stay true without confusing devotion with self-erasure.',
    'positive',
  ],
  [
    'Unglück · Misfortune',
    'disruption',
    'An unwelcome event interrupts the expected course. Attend first to safety and facts; meaning can be made after the shock.',
    'challenging',
  ],
  [
    'Unverhoffte Freude · Unexpected Joy',
    'surprise',
    'Good news or delight arrives from outside the plan. Receive it fully instead of demanding that joy justify its entrance.',
    'positive',
  ],
  [
    'Verdruss · Annoyance',
    'friction',
    'Irritation exposes a repeated obstruction or a boundary left unspoken. Address the cause before the mood directs the response.',
    'challenging',
  ],
  [
    'Verlust · Loss',
    'absence',
    'Something valued is missing, spent, or no longer available. Take an honest inventory before deciding what can be restored.',
    'challenging',
  ],
  [
    'Witwe · Widow',
    'seasoned independence',
    'A woman shaped by loss, endurance, or self-reliance influences the matter. Respect experience without reducing her to sorrow.',
    'neutral',
  ],
  [
    'Witwer · Widower',
    'seasoned solitude',
    'A man shaped by loss, endurance, or self-reliance influences the matter. His reserve may hold both wisdom and unfinished grief.',
    'neutral',
  ],
] as const satisfies readonly Entry[];

const zigeunerGlyphs = [
  '⚓',
  '⌂',
  '✉',
  '▱',
...
const zigeunerCards: CardDefinition[] = zigeunerEntries.map(
  ([name, keyword, meaning, polarity], index) => ({
    id: `zigeuner-${index + 1}`,
    name,
    glyph: zigeunerGlyphs[index % zigeunerGlyphs.length],
    keywords: [keyword, name.split(' · ')[0]],
    meaning,
    domain: 'person or circumstance',
    numerology: index + 1,
    polarity,
    image: traditionalImage('zigeunerkarten', index),
    aspectRatio: 2 / 3,
    provenance:
      'Traditional Zigeunerkarten subject paired with a distinct CC0/public-domain Art Institute of Chicago work in a modern historical-art edition; original DIVINE interpretation, not a reproduction of a commercial pack.',
  }),
);

type RamlEntry = readonly [
  name: string,
...
const ramlEntries = [
  [
    ...
    '2222',
    'collectivity',
    'Many voices, conditions, or people gather without one force dominating. Receive the field before trying to direct it.',
    'neutral',
  ],
  [
    'Tristitia',
    ...
    '2221',
    'descent',
    'Weight, gravity, and necessary limitation pull attention downward. Work with the constraint and reinforce the foundation.',
    'challenging',
  ],
  [
    'Albus',
    ...
    '2212',
    'clarity',
    'Clear thought, measured speech, and wise counsel cool the situation. Choose understanding before acceleration.',
    'positive',
  ],
  [
    'Fortuna Major',
    'Nuṣrat al-dākhil · inward victory',
    '2211',
    'enduring success',
    'Strength gathers inwardly and can sustain a favorable result. Build for duration rather than display.',
    'positive',
  ],
  [
    'Rubeus',
    ...
    '2122',
    'volatile heat',
    'Passion, anger, or appetite runs hot enough to overwhelm judgment. Contain the fire before deciding what it should power.',
    'challenging',
  ],
  [
    'Acquisitio',
    'Qabḍ al-dākhil · inward grasp',
    '2121',
    'gain',
    'Something useful can be acquired: knowledge, means, support, or material benefit. Know what the gain asks you to hold.',
    'positive',
  ],
  [
    'Coniunctio',
    ...
    '2112',
    'convergence',
    'Separate paths cross and exchange becomes possible. Let the meeting reveal what neither side could make alone.',
    'neutral',
  ],
  [
    'Caput Draconis',
    'ʿAtabat al-dākhil · inner threshold',
    '2111',
    'entry',
    'A threshold opens toward beginning, arrival, or increase. Enter attentively; the first step shapes what follows.',
    'positive',
  ],
  [
    'Laetitia',
    ...
    '1222',
    'rising joy',
    'The movement rises toward relief, confidence, and generous perspective. Allow joy to make the field larger.',
    'positive',
  ],
  [
    'Carcer',
    ...
    '1221',
    'enclosure',
    'A boundary, duty, institution, or delay contains the matter. Structure can protect or imprison; identify which is happening.',
    'neutral',
  ],
  [
    'Amissio',
    'Qabḍ al-khārij · outward grasp',
    '1212',
    'release',
    'Holding loosens and something passes away, is spent, or must be offered. Loss may clear the hand for a better use.',
    'challenging',
  ],
  [
    'Puella',
    ...
    '1211',
    'harmony',
    'Grace, receptivity, beauty, and social intelligence soften the exchange. Invite agreement without avoiding substance.',
    'positive',
  ],
  [
    'Fortuna Minor',
    'Nuṣrat al-khārij · outward victory',
    '1122',
    'passing success',
    'Momentum produces a visible but temporary advantage. Act while support is present and do not mistake speed for permanence.',
    'positive',
  ],
  [
    'Puer',
    'Faraḥ · spirited force',
    '1121',
    'initiative',
    'Direct force, courage, and competitive energy demand motion. Aim the impulse before it chooses conflict for you.',
    'neutral',
  ],
  [
    'Cauda Draconis',
    'ʿAtabat al-khārij · outer threshold',
    '1112',
    'exit',
    'A cycle moves toward departure, decrease, or closure. Complete the leaving cleanly instead of carrying its residue forward.',
    'challenging',
  ],
  [
    'Via',
    ...
    '1111',
    'movement',
    'The road itself is the answer: change, travel, and continuing motion. Stay responsive rather than forcing an early conclusion.',
    'neutral',
  ],
] as const satisfies readonly RamlEntry[];

const ramlCards: CardDefinition[] = ramlEntries.map(
  ([name, arabicVariant, pattern, keyword, meaning, polarity], index) => ({
    id: `raml-${index + 1}`,
    name,
    glyph: pattern
      .split('')
      .map((count) => (count === '1' ? '•' : '••'))
      .join(' '),
    keywords: [keyword, arabicVariant],
    meaning,
    domain: arabicVariant,
    numerology: index + 1,
    polarity,
  ...
  },
  {
    ...
    spreads: [
      spread(
        'single',
        'Single situation',
        'One person, event, or condition at the center.',
        ['Situation'],
        'single',
      ),
      spread(
        'line-three',
        'Three-card Line',
        'Context, central matter, and immediate development.',
        ['Context', 'Matter', 'Development'],
        'line',
      ),
      spread(
        'tableau-thirty-six',
        'Large Tableau',
        'The complete deck read through proximity, clusters, and direction.',
        Array.from({ length: 36 }, (_, index) => `Field ${index + 1}`),
        'tableau',
      ),
    ],
    cover: '/traditional-decks-v1/zigeunerkarten/zigeunerkarten-17.webp',
  },
  {
    slug: 'ilm-al-raml',
    index: '18',
    name: 'ʿIlm al-Raml Cards',
    shortName: 'ʿIlm al-Raml',
    kind: 'cards',
    countLabel: '16 figures',
    eyebrow: 'Figure / Movement',
    introduction:
      'The sixteen canonical geomantic figures appear over folios from an Arabic treatise on the “science of sand.”',
    instruction:
      'Use this card draw to study a figure’s quality. It does not calculate a traditional shield chart, witnesses, or judge from generated lines.',
    cards: ramlCards,
    spreads: [
      spread(
        'single-figure',
        'Single Figure',
        'One figure names the movement active now.',
        ['Figure'],
        'single',
      ),
      spread(
        'four-mothers',
        'Four Mothers',
        'A modern card study of the four opening figures in a geomantic tableau.',
        ['First Mother', 'Second Mother', 'Third Mother', 'Fourth Mother'],
        'grid',
      ),
    ],
    cover: '/traditional-decks-v1/ilm-al-raml/ilm-al-raml-16.webp',
  },
];
