...
const majorArcana: Array<[string, string, string, string, string]> = [
  [
    ...
    '0',
    'beginning',
    'A beginning arrives before certainty. Step toward it with an open hand.',
    'Freedom becomes drift when instinct refuses every boundary.',
  ],
  [
    'The Magician',
    'I',
    'will',
    'The needed instruments are already near. Direct them with precision.',
    'Power is scattering through performance, hesitation, or divided intent.',
  ],
  [
    'The High Priestess',
    'II',
    'knowing',
    'The quiet answer is the true one. Let what is hidden finish speaking.',
    'Silence has become avoidance; name the knowledge you keep postponing.',
  ],
  [
    'The Empress',
    'III',
    'abundance',
    'What you tend now will multiply. Receive as generously as you create.',
    'Care has tipped into depletion or control; restore your own ground.',
  ],
  [
    'The Emperor',
    'IV',
    'structure',
    'Order gives the vision a body. Set the boundary and hold it.',
    'A rigid structure is protecting an old fear rather than the future.',
  ],
  [
    'The Hierophant',
    'V',
    'tradition',
    'A trusted lineage, teacher, or practice reveals the next step.',
    'Inherited rules must be examined before they are obeyed.',
  ],
  [
    'The Lovers',
    'VI',
    'choice',
    'Alignment asks for a wholehearted choice, not a perfect guarantee.',
    'Desire and values are parting ways; decide which voice leads.',
  ],
  [
    'The Chariot',
    'VII',
    'direction',
    'Opposing forces can move together once you choose the destination.',
    'Force without inner agreement creates motion but not progress.',
  ],
  [
    'Strength',
    'VIII',
    'courage',
    'Gentle mastery will achieve what pressure cannot.',
    'Self-doubt is louder than the danger; meet it without cruelty.',
  ],
  [
    'The Hermit',
    'IX',
    'solitude',
    'Withdraw long enough to hear the guidance beneath other voices.',
    'Isolation has outlived its wisdom; carry the lantern back.',
  ],
  [
    'Wheel of Fortune',
    'X',
    'change',
    'The pattern is turning. Move with the opening while it is present.',
    'Resistance repeats the cycle; change your position within it.',
  ],
  [
    'Justice',
    'XI',
    'truth',
    'A clear consequence follows a clear choice. Tell the whole truth.',
    'An imbalance persists because part of the evidence is being denied.',
  ],
  [
    'The Hanged Man',
    'XII',
    'surrender',
    'Progress comes through a changed perspective, not harder effort.',
    'Suspension has become delay; release the sacrifice that proves nothing.',
  ],
  [
    'Death',
    'XIII',
    'ending',
    'An ending clears the threshold. Let the former shape close completely.',
    'Clinging prolongs the ending without preserving what was loved.',
  ],
  [
    'Temperance',
    'XIV',
    'alchemy',
    'Opposites are learning a new proportion. Adjust slowly and deliberately.',
    'Excess and impatience have disturbed the mixture. Simplify.',
  ],
  [
    'The Devil',
    'XV',
    'attachment',
    'The chain is visible now, which means it can be loosened.',
    'Denial disguises the attachment; freedom begins with naming it.',
  ],
  [
    'The Tower',
    'XVI',
    'revelation',
    'What cannot remain is falling quickly. Save truth, not appearances.',
    'A necessary disruption is being delayed, making the structure more fragile.',
  ],
  [
    'The Star',
    'XVII',
    'renewal',
    'Hope becomes practical when you offer your true self to the future.',
    'Discouragement has obscured a real source of renewal. Look again.',
  ],
  [
    'The Moon',
    'XVIII',
    'mystery',
    'Move carefully through partial light. Dreams carry useful evidence.',
    'Confusion breaks when fear is separated from intuition.',
  ],
  [
    'The Sun',
    'XIX',
    'vitality',
    'Clarity, warmth, and recognition arrive without disguise.',
    'Joy is present but difficult to receive; release the need to diminish it.',
  ],
  [
    'Judgement',
    'XX',
    'awakening',
    'The call is unmistakable. Answer from who you have become.',
    'An old verdict is preventing renewal; revise it with compassion.',
  ],
  [
    'The World',
    'XXI',
    'completion',
    'The cycle closes with integration. Stand inside what you completed.',
    'The final step remains undone because completion changes your identity.',
  ],
];
...
const suits = [
  {
    ...
    element: 'fire',
    gift: 'Desire becomes movement when it is given a worthy direction.',
    shadow:
      'Energy burns without purpose; choose the work that deserves the flame.',
  },
  {
    id: 'cups',
    name: 'Cups',
    ...
    element: 'water',
    gift: 'Feeling carries information that logic alone cannot hold.',
    shadow:
      'Emotion is flooding the signal; make room without surrendering direction.',
  },
  {
    id: 'swords',
    name: 'Swords',
    ...
    element: 'air',
    gift: 'A precise thought cuts through the confusion and names what matters.',
    shadow:
      'The mind is turning its sharpness inward; question the story, not your worth.',
  },
  {
    id: 'pentacles',
    name: 'Pentacles',
    ...
    element: 'earth',
    gift: 'Patient attention makes the intangible real and sustainable.',
    shadow:
      'Security has become stagnation; value must circulate to remain alive.',
  },
];
...
const ranks = [
  {
    ...
    light:
      'A concentrated beginning asks to be accepted before it is understood.',
    dark: 'The seed is present but cannot open under pressure.',
  },
  {
    id: 'two',
    name: 'Two',
    theme: 'choice and balance',
    light: 'Two forces can become a dialogue instead of a contest.',
    dark: 'Indecision is spending the energy that choice requires.',
  },
  {
    id: 'three',
    name: 'Three',
    theme: 'growth and expression',
    light: 'The first visible result confirms that collaboration is working.',
    dark: 'Growth is being measured too early or shared too thinly.',
  },
  {
    id: 'four',
    name: 'Four',
    theme: 'stability and rest',
    light: 'A stable form creates the pause needed for integration.',
    dark: 'Protection has hardened into resistance.',
  },
  {
    id: 'five',
    name: 'Five',
    theme: 'friction and change',
    light: 'Conflict reveals the adjustment the system has resisted.',
    dark: 'Struggle is being repeated after its lesson has arrived.',
  },
  {
    id: 'six',
    name: 'Six',
    theme: 'harmony and passage',
    light: 'Movement toward balance is already underway.',
    dark: 'A past agreement is distorting the present exchange.',
  },
  {
    id: 'seven',
    name: 'Seven',
    theme: 'assessment and resolve',
    light: 'Pause, assess the field, and protect the truest intention.',
    dark: 'Suspicion or fatigue is making every option look hostile.',
  },
  {
    id: 'eight',
    name: 'Eight',
    theme: 'momentum and mastery',
    light: 'Repetition becomes skill; focused action accelerates the outcome.',
    dark: 'Speed is replacing discernment.',
  },
  {
    id: 'nine',
    name: 'Nine',
    theme: 'attainment and threshold',
    light: 'The work is nearly whole. Hold steady at the threshold.',
    dark: 'Exhaustion is disguising how close completion is.',
  },
  {
    id: 'ten',
    name: 'Ten',
    theme: 'completion and consequence',
    light: 'The full consequence of the cycle can now be carried forward.',
    dark: 'Completion has become burden because nothing is being released.',
  },
  {
    id: 'page',
    name: 'Page',
    theme: 'message and discovery',
    light: 'Curiosity brings news from an unfamiliar direction.',
    dark: 'A message is immature, delayed, or heard only selectively.',
  },
  {
    id: 'knight',
    name: 'Knight',
    theme: 'pursuit and motion',
    light: 'Commitment gathers speed around a single aim.',
    dark: 'Momentum has outrun wisdom.',
  },
  {
    id: 'queen',
    name: 'Queen',
    theme: 'embodied wisdom',
    light: 'Inner authority shapes the room without demanding attention.',
    dark: 'Care or control is being used to avoid vulnerability.',
  },
  {
    id: 'king',
    name: 'King',
    theme: 'stewardship and command',
    light: 'Experience can now direct the whole field responsibly.',
    dark: 'Authority is defending itself instead of serving the outcome.',
  },
];
...
const simpleSpreads = (
  ...
  spread(
    'three',
    threeName,
    'A three-part movement through the question.',
    positions3,
    'line',
  ),
...
const lenormand = makeNamedDeck(
  ...
  lenormandEntries,
  ['♢', '✣', '○', '⌁'],
  'Read it plainly, then notice which neighboring symbol changes its tone.',
...
const zodiac = makeNamedDeck(
  ...
  ['☉', '☾', '○', '✦'],
  'This archetype shows where celestial pressure becomes personal choice.',
...
export const SYSTEMS: SystemDefinition[] = [
  ...
  },
  {
    ...
    introduction:
      'Forty-four original images speak through association rather than doctrine. The first recognition is often the truest.',
    instruction: 'Let the image choose the pace. There is nothing to solve.',
    cards: oracle,
  ...
  },
  {
    ...
    introduction:
      'Lenormand is direct, practical, and relational. Each symbol speaks plainly; its neighbors complete the sentence.',
    instruction: 'Ask for the shape of events, then read from near to far.',
    cards: lenormand,
    spreads: [
      spread(
        'single',
  ...
  },
  {
    ...
    introduction:
      'A contemporary ritual deck for turning intention into a material act. Every symbol asks for participation.',
    instruction:
      'Name what you are willing to change—not only what you want to receive.',
    cards: spellcraft,
  ...
  },
  {
    ...
    introduction:
      'A contemporary oracle shaped by enduring Egyptian images of balance, passage, renewal, and sacred order.',
    instruction:
      'Approach each name as living history, not decoration. Receive the symbol before interpreting it.',
    cards: egypt,
    spreads: simpleSpreads(
      'Single symbol',
  ...
  },
  {
    ...
    eyebrow: 'Sky / Timing',
    introduction:
      'Signs describe the quality, planets the impulse, and houses the field. Together they locate the pressure and its possible expression.',
    instruction:
      'Choose the part of life that feels most active, then let the sky reorganize the question.',
    cards: zodiac,
    spreads: [
      spread(
        'archetype',
  ...
  },
  {
    ...
    introduction:
      'A familiar instrument of decisive chance, recast in DIVINE monochrome. Ask only what can be answered yes or no.',
    instruction:
      'Hold the question in mind. Shake until certainty loosens its grip.',
    cards: [],
    spreads: [],
  ...
  },
  {
    ...
    introduction:
      'A small fracture, a narrow paper, a sentence arriving at exactly the wrong—or right—time.',
    instruction:
      'Choose without studying the options. The hand already knows which shell to break.',
    cards: [],
    spreads: [],
