...
- **Playing-card cartomancy (52):** Austin Gabriel's complete French-suited deck, released under CC0, recolored and framed in an original warm archival print treatment without changing suit or rank.
...
- **Runic cards (24):** public-domain standardized Elder Futhark letterforms layered over crops of the Kylver Stone, photographed by Bengt A Lundberg / Riksantikvarieämbetet and licensed CC BY 2.5. The app explicitly describes the cards and their readings as a modern reflective presentation rather than an ancient divination deck.
- **I Ching cards (64):** public-domain hexagram forms in the King Wen sequence layered over the public-domain 1701 diagram sent by Joachim Bouvet to Gottfried Wilhelm Leibniz. The card format is a modern interface and does not replace a traditional changing-line consultation.
...
- **ʿIlm al-raml (16):** the complete sixteen geomantic figures are rendered as solid mineral-ink points in ruled panels over distinct Public Domain Mark images from Wellcome Collection MS Arabic 664, an Arabic treatise on ʿilm al-raml. The fixed deck is explicitly identified as a modern interface adaptation rather than a replacement for a generated geomantic tableau.
...
- Kylver Stone photograph: <https://commons.wikimedia.org/wiki/File:G88_Kylver_-_KMB_-_16000300013409.jpg>
- I Ching: <https://commons.wikimedia.org/wiki/Category:I_Ching_hexagrams>
- 1701 Bouvet–Leibniz diagram: <https://commons.wikimedia.org/wiki/File:Diagram_of_I_Ching_hexagrams_owned_by_Gottfried_Wilhelm_Leibniz,_1701.jpg>
