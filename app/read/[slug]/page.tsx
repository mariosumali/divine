...
const PRODUCTION_ORIGIN = 'https://divine-readings.grassy-peony-5538.chatgpt.site';
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title,
    description,
    openGraph: { title, description, images: [{ url: image, width: 1122, height: 1402, alt: `${system.name} cover artwork` }] },
